...
background_image = Image.open("images/kmclu.jpg")
...
message = tk.Label(window, text="KMCLU Face Attendance System ", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Enrollment", width=20, height=3, fg="black", bg="white", font=('times', 15, ' bold '))
...
lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black", bg="white", height=3, font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="Check Register students",command=admin_panel,fg="black"  ,bg="pale goldenrod"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
AP.place(x=990, y=500)

takeImg = tk.Button(window, text="Take Images",command=take_img,fg="black"  ,bg="pale green"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
takeImg.place(x=90, y=500)

trainImg = tk.Button(window, text="Train Images",fg="black",command=trainimg ,bg="khaki1"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
trainImg.place(x=390, y=500)

FA = tk.Button(window, text="Automatic Attendance",fg="black",command=subjectchoose  ,bg="alice blue"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
